async function loader() {
    try {
      ...
      const responseHeader = fetch('/java/src/main/resources/static/pages/header.html');
      const responseFooter = fetch('/java/src/main/resources/static/pages/footer.html');
